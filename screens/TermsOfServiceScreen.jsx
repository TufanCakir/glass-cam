      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        <View>
          <Text style={styles.content}>
            Nutzungsbedingungen{"\n\n"}
            Willkommen bei [Glass Cam]! Diese Nutzungsbedingungen regeln Ihre
            Nutzung unserer App und Dienste. Bitte lesen Sie diese Bedingungen
            sorgfältig durch, bevor Sie unsere App verwenden. Durch die Nutzung
            der App stimmen Sie diesen Bedingungen zu.{"\n\n"}
